      ...
      <Row>
        <Col>
          ...
          <p className={adverbs ? styles.description : styles.disabled}>
            Adverbs are words or phrases that modify or qualify an adjective, verb, or other adverb or a word group,
          ...
          <p className={verbs ? styles.description : styles.disabled}>
            Verbs are words used to describe an action, state, or occurrence, and forming the main part of the predicate
          ...
          <p className={nouns ? styles.description : styles.disabled}>
            Nouns are words (other than a pronouns) used to identify any of a class of people, places, or things (common
