...
const GenkiChapter2 = () => {
    const c2p1: GrammarInfoProps = {
        ...
        body: (
            <div>
                <p>
                    When you want to talk about things you do not know the name of, you can use such expressions as
                    kore, sore, are, and dore. Kore refers to something close to the speaker; sore refers to something
                    close to the person you’re talking to; are refers to an object that is neither close to the speaker
                    or the listener.
                </p>
                ...
                <p>
                    Dore means can be used to express “which.” Question words like dore and nani cannot be followed by
                    the particle wa. Instead, they must be followed by the particle ga.
                </p>
    ...
    const c2p2: GrammarInfoProps = {
        ...
        body: (
            <div>
                <p>
                    Kore, sore, are, and dare can be modified by replacing the final re with no to specify an object. It
                    is important to note that kono, sono, ano, and dono cannot stand alone: they must be followed by a
                    noun. For example, if you know that the item in your hand is a watch (tokee) you can say:
                </p>
        ...
        body: (
            <div>
                ...
                <p>
                    ...
                    formal replacement for nai desu is arimasen. Ja is a contraction of de wa, which is more formal and
                    more appropriate in the written language. Thus in addition to the above sentence, you also find:
                </p>
    ...
    const c2p7: GrammarInfoProps = {
        ...
        body: (
            <div>
                <p>
                    Statements often end with the tags ne or yo, depending on the way the speaker views the interaction
                    with the listener. If the speaker is seeking the listeners confirmation or agreement to what has
                    been said, then ne (“right?”) could be added.
                </p>
