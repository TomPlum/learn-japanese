    ...
    const c16p2: GrammarInfoProps = {
        ...
        body: (
            <div>
                ...
                <p>
                    The <em>te</em>-form + くれませんか is a request which is roughly equal in the degree of politeness
                    to ください. くれませんか of course comes from the verb くれる. This is probably the form most
                    appropriate in the host-family context.
                </p>
                ...
                <p>
                    The <em>te</em>-form + くれない, or the <em>te</em>-form by itself, to ask for a favour in a very
                    casual way. This is good for speaking with members of your peer group.
                </p>
