  ...
  const c15p2: GrammarInfoProps = {
    ...
    body: (
      <div>
        ...
        <p>
          You can also use the Volitional Form + と思っています, which suggests that the decision to perform the
          activity is being made on the <em>spot</em> at the time of speaking.
        </p>
        <p>
          と思っています, in contrast, tends to suggest that you have <em>already decided</em> to do something.
        </p>
  ...
  const c15p4: GrammarInfoProps = {
    ...
    body: (
      <div>
        ...
        <p>
          When the subject of the verb appears inside a qualifier sentence, it is accompanied by the particle が, and
          not は.
        </p>
        <p>
          The verbs used in such qualifier sentences are in their short forms, either in the present, and either in the
