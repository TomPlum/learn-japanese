...
import styles  from "./MistakesCard.module.scss"
    ...
    <DashboardCard size="sm" className={styles.card} loading={!ready}>
      ...
      <DashboardCard.Body className={styles.body}>
        ...
        <div className={styles.types}>
          <div className={styles.type} title={t("kanji")}>
            字
          </div>
          <div className={styles.type} title={t("kana")}>
            あ
          </div>
          <div className={styles.type} title={t("definitions")}>
            A
          </div>
        </div>
      </DashboardCard.Body>
