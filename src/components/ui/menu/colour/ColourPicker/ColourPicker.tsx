...
const ColourPicker = (props: ColourPickerProps) => {
  ...
  return (
    <div className={[className, styles.wrapper].join(" ")} data-testid="colour-picker">
      ...
      <SliderPicker color={colour} onChange={handleChange} className={styles.picker} onChangeComplete={handleChange} />
      <Form.Control value={colour} placeholder="Colour" className={styles.input} onChange={handleHexChange} />
    </div>
  )
}
