            ...
            <Row>
                ...
                <Col xl={2} md={3} xs={6} className={styles.middleCol}>
                    <Pagination className={styles.bookSelector}>
                        <Pagination.Item
                            className={genkiOneClasses}
                            onClick={onChangeGenkiOne}
                            title={getToggleTitle(genkiOne)}
                        >
                            Genki I
                        </Pagination.Item>
                        <Pagination.Item
                            className={genkiTwoClasses}
                            onClick={onChangeGenkiTwo}
                            title={getToggleTitle(genkiTwo)}
                        >
                            Genki II
                        </Pagination.Item>
                    </Pagination>
