import styles  from "./GenkiComparisonDisplay.module.scss"
    ...
    <div className={styles.wrapper} style={{ padding: noPadding ? 0 : undefined }}>
      ...
      <div className={styles.comparison} style={{ textAlign: centerComparisons ? "center" : "start" }}>
        ...
        <div>
          ...
          {secondComparison.description && <span className={styles.desc}>{secondComparison.description}</span>}
        </div>
        ...
        {thirdComparison && (
          <div>
            ...
            {thirdComparison.description && <span className={styles.desc}>{thirdComparison.description}</span>}
          </div>
        )}
      </div>
