...
import DashboardCardFooter from "../../../../components/layout/card/DashboardCardFooter";

test('Should render the children', () => {
    const component = render(<DashboardCardFooter><span>Example Content</span></DashboardCardFooter>);
