...
import DataSettingsMenu, { DataSettingsMenuProps } from "../../../../components/settings/data/DataSettingsMenu";
...
const setup = () => {
    const component = render(<DataSettingsMenu {...props}><p>The Children</p></DataSettingsMenu>);
    return {
