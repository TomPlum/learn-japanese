...
each(["", "tom@domain", "tomhotmail.com", "tom@aol.c"]).test(
  "Typing an invalid email address [%s] should disable the register button",
  async (value: string) => {
    await setValidFields()
...
each(["", "a", "ab", "abcdefghijklmnoq"]).test(
  "Typing an invalid username [%s] should disable the register button",
  async (value: string) => {
    await setValidFields()
...
each(["", "a", "ab", "abcdefghijklm"]).test(
  "Typing an invalid nickname [%s] should disable the register button",
  async (value: string) => {
    await setValidFields()
...
each(["P4ssw0rd", "Password-", "P4SSW0RD-", "p4ssw0rd-", "P4swrd-", "Aa0-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"]).test(
  "Typing an invalid password [%s] should disable the register button",
  async (value: string) => {
    await setValidFields()
...
each(["P4ssw0rd", "Password-", "P4SSW0RD-", "p4ssw0rd-", "P4swrd-", "Aa0-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"]).test(
  "Typing an invalid secondary password [%s] should disable the register button",
  async (value: string) => {
    await setValidFields()
