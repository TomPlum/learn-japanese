            ...
            ctx.json({
                learn: [
                    ...
                    },
                    {
                        ...
                        description:
                            "Includes only the 25 non-diagraph voiced consonants from both syllabaries for a total of 50.",
                        icon: "ざ",
                        colour: "#1785e2",
                        topic: "Hiragana & Katakana",
                        data: {
                    ...
                    },
                    {
                        ...
                        description:
                            "Includes the 1026 kanji as per the Japanese Ministry of Education taught from grades 1 to 6.",
                        icon: "FaSchool",
                        colour: "#fdb40e",
                        topic: "Jōyō Kanji",
                        data: {
                    ...
                    },
                    {
                        ...
                        name: "presets.learn.colours.name",
                        description:
                            "Commonly used colours and their variants plus various miscellaneous related words.",
                        icon: "FaPalette",
                        colour: "#fd0e3e",
                        topic: "Basics",
                        data: {
                    ...
                    },
                    {
                        ...
                        description:
                            "Animals that you mind find at home as pets or at a zoo or sanctuary while in Japan.",
                        icon: "FaCat",
                        colour: "#ff7730",
                        topic: "Basics",
                        data: {
                    ...
                    },
                    {
                        ...
                        description:
                            "Directional words used when describing the locations of things plus compass directions.",
                        icon: "FaCompass",
                        colour: "#1785e2",
                        topic: "Basics",
                        data: {
                    ...
                    },
                    {
                        ...
                        description:
                            "Adverbs are words or phrases that modify or qualify an adjective, verb or other adverb.",
                        icon: "FaExclamation",
                        colour: "#5641d0",
                    ...
                    },
                    {
                        ...
                        description:
                            "Commonly used expressions, pronouns & prepositions used in everyday conversation.",
                        icon: "FaComment",
                        colour: "#1785e2",
                        topic: "Sentence Structure",
                        data: {
                ...
                play: [
                    ...
                    },
                    {
                        ...
                        description:
                            "You're shown a single kana and must enter the rōmaji. You're timed and have 5 lives.",
                        icon: "FaFont",
                        colour: "#1785e2",
                        topic: "Hiragana & Katakana",
                        data: {
                    ...
                    },
                    {
                        ...
                        description:
                            "You're presented with the rōmaji for a random kana and four characters to choose from.",
                        icon: "FaKickstarterK",
                        colour: "#7e2bd7",
                        topic: "Hiragana & Katakana",
                        data: {
                    ...
                    },
                    {
                        ...
                        description:
                            "You're given 3 kana per question and must match up each character to its respective rōmaji.",
                        icon: "FaBezierCurve",
                        colour: "#38c742",
                        topic: "Hiragana & Katakana",
                        data: {
                    ...
                    },
                    {
                        ...
                        name: "presets.play.match.name",
                        description:
                            "You're shown 4 random kanji per question and must match them to their English meanings.",
                        icon: "FaBezierCurve",
                        colour: "#e79711",
                        topic: "Jōyō Kanji",
                        data: {
                    ...
                    },
                    {
                        ...
                        description:
                            "Words used for counting things or sequences such as first, second, half, next etc.",
                        icon: "FaSort",
                        colour: "#fc3131",
                        topic: "Numbers & Counting",
                        data: {
