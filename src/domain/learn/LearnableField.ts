export default class LearnableField {
  ...
  public static fromTranslationPath(value: string): LearnableField {
    switch (value) {
      case "learnable.field.meaning.name":
        return LearnableField.MEANING
      case "learnable.field.kanji.name":
        return LearnableField.KANJI
      case "learnable.field.kana.name":
        return LearnableField.KANA
      case "learnable.field.japanese.name":
        return LearnableField.JAPANESE
      case "learnable.field.romaji.name":
        return LearnableField.ROMAJI
      case "learnable.field.on.name":
        return LearnableField.ONYOMI_READING
      case "learnable.field.kun.name":
        return LearnableField.KUNYOMI_READING
      case "learnable.field.random.name":
        return LearnableField.RANDOM
      default:
        throw new Error("Invalid Learnable Field Translation Path: " + value)
    }
  }
