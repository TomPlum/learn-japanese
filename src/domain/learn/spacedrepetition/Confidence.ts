import { faGrinBeam, faMeh, faSadCry, faSadTear, faSmile, faSmileWink, IconDefinition } from "@fortawesome/free-solid-svg-icons";
...
export default class Confidence {
     ...
     */
    public static INCORRECT_BUT_REMEMBERED = new Confidence(1, "Incorrect, but knew", "You gave an incorrect answer, but you realised you knew it afterwards.", faSadTear);
     ...
     */
    public static INCORRECT_OBVIOUS_AFTERWARDS = new Confidence(2, "Incorrect, but was obvious",  "You gave an incorrect answer, but it was obvious to you afterwards.", faMeh);
     ...
     */
    public static CORRECT_SMALL_HESITATION = new Confidence(4, "Correct, small hesitation", "You gave the correct answer after some hesitation.", faSmileWink);

    /**
     * The user gave a correct response.
     * Everything was remembered perfectly without hesitation.
     */
    public static PERFECT = new Confidence(5, "Perfect", "You gave the correct answer with no hesitation at all.", faGrinBeam);
